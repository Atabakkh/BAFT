...
<body>
	...
	<form action="optimizedsearch" method="get" name="optimizedsearchForm"
		enctype="multipart/form-data">
		<fieldset>
			<p>
				<input id="optimizedsearchGene" name="optimizedsearchGene"
					type="search" size="50">
			</p>

			<p></p>
			<input name="optimizedsearch" type="submit" value="Optimized Search">
		</fieldset>
	</form>
