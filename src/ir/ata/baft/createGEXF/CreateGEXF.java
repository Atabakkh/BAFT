...
public class CreateGEXF {
    ...
    public void testStaticGexfGraph() throws IOException, SAXException {
        ...
        InputStream inputStream = CreateGEXF.class.getResourceAsStream("c:/servlet/staticGraph.gexf");
...
//        date.setTimeZone(TimeZone.getTimeZone("GMT+0300"));
        ...
        InputStream inputStream = CreateGEXF.class.getResourceAsStream("/dynamicGraph.gexf");
        String myControlXML = IOUtils.toString(inputStream, "UTF-8");
